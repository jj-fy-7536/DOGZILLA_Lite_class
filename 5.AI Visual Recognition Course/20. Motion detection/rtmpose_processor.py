    ...
    def init_rtmpose(self, mode='balanced'):
        ...
        try:
            ...
            if os.path.exists(models_dir):
                # 尝试使用本地模型
                det_model = os.path.join(models_dir, 'yolox_m_8xb8-300e_humanart-c2c7a14a.onnx')
                ...
                if mode == 'lightweight':
                    ...
                    pose_model = os.path.join(models_dir, 'rtmw-dw-x-l_simcc-cocktail14_270e-256x192_20231122.onnx')
                    pose_input_size = (192, 256)
